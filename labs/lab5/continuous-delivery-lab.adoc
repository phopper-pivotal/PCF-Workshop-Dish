...
. Login to your Jenkins instance at https://jenkins-0.some.domain.dish.com/ with the same username and password that you use for CloudFoundry.
...
export API=https://api.some.domain.dish.com
