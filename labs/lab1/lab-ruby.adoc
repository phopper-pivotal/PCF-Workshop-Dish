...
. Edit the _manifest.yml_ file to give your app a unique name _(only necessary if multiple users are sharing a space)_  Change _scale_demo_ to _scale_demo-<yourname>_:
+
----
applications:
- name: scale-demo-phopper
  memory: 512M
----
...
====
----
Using manifest file /Users/phopper/workspace/DISH-PCF-Workshop-101/pcf-autoscale/manifest.yml <1>
...
Uploading app files from: /Users/phopper/workspace/DISH-PCF-Workshop-101/pcf-autoscale
